        ...
        {items.length === 0 ? (
          <div className="flex min-h-[500px] flex-col items-center justify-center text-center">
            ...
            <p className="mt-3 max-w-md text-sm leading-6 text-gray-500">
              Discover a fragrance that feels uniquely yours and add it to your collection.
            </p>
            <Link
              href="/products"
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-gray-500">
                      Your order is protected from checkout to delivery.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="border-t border-black/10 bg-black px-5 py-16 text-white sm:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-white/60">
              Every fragrance is carefully selected for people who appreciate character, elegance and unforgettable presence.
            </p>
          </div>
        </section>
      )}
